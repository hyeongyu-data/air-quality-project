...
KST 00·06·12·18시에 기상청/에어코리아 API에서 데이터를 수집하고
...
실행 스케줄: 6시간마다 (KST 00·06·12·18시)

producer.collect_scheduled_weather()가 이 네 시각에만 분기를 정의한다.
매시간 돌리면 24회 중 20회가 "정의되지 않은 실행 시각" 경로로 떨어지고
공공 API 호출만 6배가 된다.
"""
